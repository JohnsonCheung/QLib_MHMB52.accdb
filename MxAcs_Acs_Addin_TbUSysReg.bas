Attribute VB_Name = "MxAcs_Acs_Addin_TbUSysReg"
Option Compare Text
Option Explicit
Const CMod$ = "MxAcs_Acs_Addin_TbUSysReg."
...
Dim FunNm$
Stop '
RunqQQ D, "Insert into [USysRegInf] Values('?',0,'','')"
RunqQQ D, "Insert into [USysRegInf] Values('?',1,'Expression','?')", Sk, FunNm
RunqQQ D, "Insert into [USysRegInf] Values('?',1,'Library','?')", Sk, Fba
End Sub
